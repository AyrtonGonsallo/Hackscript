...
if(($_GET['aim']=="help")){
    echo "command : <br>
    tester : http://localhost/alljudotest/admin/ancient.php?table=champions&nor=3&champ_tri=Nom&ordre=DESC&conds=Nom_like_^@laurent@^&aim=test
    <br>
    recuperer : http://localhost/alljudotest/admin/ancient.php?table=champions&nor=3&champ_tri=Nom&ordre=DESC&conds=Nom_like_^@laurent@^&aim=get
    <br>
    sup : http://localhost/alljudotest/admin/ancient.php?table=champions&field=ID&value=100&aim=delete
    ";
}
if(($_GET['aim']=="test")){
    $nor=(isset($_GET['nor']) )?$_GET['nor']:null;
